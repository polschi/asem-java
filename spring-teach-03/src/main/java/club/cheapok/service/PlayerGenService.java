...
public class PlayerGenService {
    private static List<String> firstNames = Arrays.asList("Adrian", "Victor", "Ion", "Andrei", "Cornel", "Mihai", "Gicu", "Dumitru");
    private static List<String> mutableLastNames = new ArrayList<>(Arrays.asList("Iaka", "Whatever", "Popovschi", "Gibson", "Zuckerberg", "Gates", "Hagi", "Khan"));
